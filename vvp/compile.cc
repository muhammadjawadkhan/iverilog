...
static const struct opcode_table_s opcode_table[] = {
      ...
      { "%cov/get_inst", of_COV_GET_INST, 0, {OA_NONE,   OA_NONE, OA_NONE} },
      { "%cov/new",      of_COV_NEW,      1, {OA_STRING, OA_NONE, OA_NONE} },
      { "%cov/sample",   of_COV_SAMPLE,   0, {OA_NONE,   OA_NONE, OA_NONE} },
